...
Because the adapter normalizes the output, everything downstream — the scene graph, the safety system, the planning layer, the WebSocket stream — works identically regardless of which model is running.
