...
const commands: Command[] = [
  ...
  },
  {
    ...
    output: [
      ...
      { text: "  rfdetr            detection       downloaded  39MB", color: "green" },
      { text: "  grounding_dino    grounding       downloaded  694MB", color: "green" },
      { text: "  depth_anything    depth           downloaded  97MB", color: "green" },
      { text: "  sam2              segmentation    downloaded  38MB", color: "green" },
