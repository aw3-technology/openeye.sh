...
export function mapDevice(row: DeviceRow): DeviceResponse {
  return {
    ...
    api_key: null,
    hardware_specs: (row.hardware_specs || {}) as unknown as DeviceResponse["hardware_specs"],
...
export function mapDeployment(row: DeploymentRow): DeploymentResponse {
  return {
    ...
    rollout_stages: (row.rollout_stages || []) as unknown as DeploymentResponse["rollout_stages"],
...
export function mapGroup(row: DeviceGroupRow): DeviceGroupResponse {
  return {
    ...
    auto_scaling_policy: row.auto_scaling_policy as unknown as DeviceGroupResponse["auto_scaling_policy"],
